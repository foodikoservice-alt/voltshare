  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-[400px] z-10 animate-in fade-in zoom-in-95 duration-200">
        ...
        <button
          onClick={onClose}
          className="absolute -top-3 -right-3 p-2 bg-surface-container rounded-full border border-hairline text-muted-soft hover:text-ink hover:bg-ink/10 transition-all z-20"
          title="Close"
        >
          <X className="w-4 h-4" />
        </button>

        <div className="glass-lg rounded-2xl sm:rounded-3xl p-6 sm:p-8">
          {/* Header */}
          <div className="flex flex-col items-center mb-7">
            ...
            <h2 className="text-xl font-black tracking-tight text-ink">Editor Sign In</h2>
            <p className="text-muted text-sm font-medium mt-1">Enter your editor credentials</p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-surface-container-lowest border border-hairline rounded-2xl pl-11 pr-4 py-3.5 text-sm focus:outline-none focus:border-primary/50 focus:bg-surface-container-low transition-all placeholder:text-muted-soft text-ink"
                  required
                  autoFocus
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-surface-container-lowest border border-hairline rounded-2xl pl-11 pr-4 py-3.5 text-sm focus:outline-none focus:border-primary/50 focus:bg-surface-container-low tracking-[0.5em] transition-all placeholder:text-muted-soft text-ink"
                  required
                />
              </div>
            </div>
