    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-surface">
      ...
      <div className="w-full max-w-[400px] z-10 px-0">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-white">VoltShare</h1>
          <p className="text-slate-500 font-medium mt-1">Electricity Usage Management</p>
        </div>

        <div className="glass-lg rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-2xl border-white/5">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full bg-surface-container-lowest border border-white/5 rounded-2xl pl-11 pr-4 py-4 text-sm focus:outline-none focus:border-primary/50 focus:bg-surface-container-low transition-all placeholder:text-slate-600"
                  required
                  autoFocus
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full bg-surface-container-lowest border border-white/5 rounded-2xl pl-11 pr-4 py-4 text-sm focus:outline-none focus:border-primary/50 focus:bg-surface-container-low tracking-[0.5em] transition-all placeholder:text-slate-600"
                  required
                />
              </div>
            </div>
            ...
            {error && (
              <div className="p-3 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-500 text-[11px] font-bold text-center animate-in shake duration-300">
                {error}
              </div>
            )}
