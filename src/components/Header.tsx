...
export const Header: React.FC<HeaderProps> = ({ role, totalUnits, totalCost, dark, onToggleDark, onLogout }) => {
  return (
    <header className="sticky top-0 z-30 glass-sm border-b border-white/5 px-3 sm:px-4 py-2.5 sm:py-3">
      <div className="max-w-6xl mx-auto flex items-center justify-between gap-2 sm:gap-3">
        ...
        <div className="flex items-center gap-1 sm:gap-2 shrink-0">
          ...
          <span className={`badge hidden xs:inline-flex ${role === 'editor' ? 'badge-amber' : 'badge-blue'}`}>
            {role}
          </span>
          <button
            onClick={onLogout}
